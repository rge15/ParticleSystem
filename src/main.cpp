...
int main()
{
	...
	pEmitter.addEmitterSpawn<ParticleSystem::RatioSpawner>( 4, .5f );
	pEmitter.addEmitterInit<ParticleSystem::SquarePosInit>( 0., 10. , 10., 500.);
	//pEmitter.addEmitterInit<ParticleSystem::ConstPosInit>( -20 , 0  );
	pEmitter.addEmitterInit<ParticleSystem::ConstSpeedInit>( 2.f,0.f );
